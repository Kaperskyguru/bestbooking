...
<div class="container breadcrub">
    <div>
        ...
        <a class="backbtn right" href="{{ route('flight-page') }}"></a>
    </div>
        ...
        <div class="col-md-8 pagecontainer2 offset-0">
            ...
            <div class="padding30 grey">
                ...
                <div class="alert alert-info">
                    ...
                    <p class="size12">• You have chosen the version offered by foreign partners. In case of visa issue refusal, disease, etc.
                        the refund without penalty provisions is impossible! The ticket will refunded according to the airline
                        rules.
                    </p>
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="pagecontainer2 paymentbox grey">
                ...
                <div class="hpadding30 margtop30">
                    ...
                    <div class="fdash mt10"></div><br/> Traveler 1: Adult <span class="right bold green">$787.25</span>
                    <!-- Collapse 1 -->
                    ...
                    <div class="fdash mt10"></div><br/> Traveler 2: Adult <span class="right bold green">$787.25</span>
                    <!-- Collapse 1 -->
