    ...
    <div class="container2 offset-0">
        ...
        <div class="col-md-12  offset-0">
            ...
            <div class="dashboard-left offset-0 textcenter">
                ...
                <br /><br />
                <a href="index.html"><img src="{{ asset('images/logo.png') }}" alt="" /></a><br />
                <span class="size12 grey lh5">Welcome to the Admin Panel</span><br />
                <a href="#"><img src="{{ asset('images/dash/avatar.jpg') }}" class="dash-avatar" alt="" /></a><br />
                <span class="size12 dark">Administrator</span><br />
                <a href="#"><img src="{{ asset('images/dash/logout.png') }}" alt="" /></a><br />
                <br /><br />
                ...
                <ul class="nav dashboard-tabs">
                    <li class="dropdown">
                        ...
                        <ul aria-labelledby="myTabDrop1" role="menu" class="dropdown-menu2 lftwidth">
                            ...
                            <li><a data-toggle="tab" href="#dropdown2">Updates <span class="badge indent0">10</span></a>
                            </li>
                        </ul>
                    </li>
                    <li>
                ...
                <span class="dtxt">
                    <span class="size12 grey">
                        ...
                        Built With &hearts; By <a href="www.techpadi.com.ng">TechPadi</a>.
                    </span>
                <br />
                <br />
                <br />
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="dbox-visitors">
                                    <div class="orangebox">
                                        <a href="#"><img src="{{ asset('images/dash/icon-visits.png') }}" alt="" /></a>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="dbox-visitors">
                                    <div class="cyanbox">
                                        <a href="#"><img src="{{ asset('images/dash/icon-revenue.png') }}" alt="" /></a>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="dbox-visitors">
                                    <div class="greenbox">
                                        <a href="#"><img src="{{ asset('images/dash/icon-email.png') }}" alt="" /></a>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="dbox-visitors">
                                    <div class="darkbox">
                                        <a href="#"><img src="{{ asset('images/dash/icon-bookings.png') }}" alt="" /></a>
                                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="chartcontainer">
                                ...
                                <div class="wh33percent left textcenter">
                                    <div class="chart2 center" data-percent="81"><span class="countnewvisits">81</span>%
                                    </div>
                        ...
                        <div class="col-md-12 offset-0">
                            <div class="col-md-6 offset-0">
                                ...
                                <ul class="nav navigation-tabs2">
                                    <li class="active"><a href="#tab-newtopic" data-toggle="tab">Topics <span
                                                class="badge cbhide">6</span></a></li>
                                    <li><a href="#tab-comments" data-toggle="tab">Comments <span
                                                class="badge cbhide">1</span></a></li>
                                    <li><a href="#tab-blogcomments" data-toggle="tab">Blog <span
                                                class="badge cbhide">2</span></a></li>
                                </ul>
                                        ...
                                        <div class="table-responsive">
                                            <div class="fixedtopic">
                                                <table class="tablehover">
                                                    <tr>
                                                        <td><img src="{{ asset('images/dash/no-avatar.jpg') }}" alt="" /></td>
                                                        <td>
                                                            <span class="dark">Load Container Content</span><br /> Lorem
                                                            ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum
                                                            et dictum urna. Donec et tortor ullamcorper, tempor ante eu,
                                                            rhoncus ligula.
                                                        </td>
                                                ...
                                                <table class="tablehover">
                                                    <tr>
                                                        <td><img src="{{ asset('images/dash/no-avatar.jpg') }}" alt="" /></td>
                                                        <td>
                                                            <span class="dark">Customize Twitter api & add sign
                                                                up/login</span><br
                                                ...
                                                <table class="tablehover">
                                                    <tr>
                                                        <td><img src="{{ asset('images/dash/no-avatar.jpg') }}" alt="" /></td>
                                                        <td>
                                                            <span class="dark">Changing top Nav text colors</span><br />                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum
                                                            et dictum urna. Donec et tortor ullamcorper, tempor ante eu,
                                                            rhoncus ligula.
                                                        </td>
                                                        <td class="cwth"><input type="checkbox" class=""></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="dark">Customize Twitter api & add sign
                                                            up/login</span><br
                                                        /> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum
                                                        et dictum urna. Donec et tortor ullamcorper, tempor ante eu, rhoncus
                                                        ligula.
                                                    </td>
                                                    <td class="cwth"><input type="checkbox" class=""></td>
                                                </tr>
                                        ...
                                        <div class="table-responsive">
                                            <table class="tablehover">
                                                <tr>
                                                    <td><img src="{{ asset('images/dash/no-avatar.jpg') }}" alt="" /></td>
                                                    <td>
                                                        <span class="dark">Changing top Nav text colors</span><br /> Lorem
                                                        ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum et
                                                        dictum urna. Donec et tortor ullamcorper, tempor ante eu, rhoncus
                                                        ligula.
                                                    </td>
                                                    <td class="cwth"><input type="checkbox" class=""></td>
                                                </tr>
                            ...
                            <div class="col-md-6 cpadding01">
                                ...
                                <br />
                                <div class="progress2 progress-striped">
                                    <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100"
                                        style="width: 55%"></div>
                                </div>
                                ...
                                <br />
                                <div class="progress2 progress-striped active">
                                    <div class="progress-bar progress-bar-black" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"
                                        style="width: 85%">
                                    </div>
                                </div>
...
<div class="masternotice none">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Message from TitanicThemes
</div>
@endsection